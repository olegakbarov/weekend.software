...
type GmailSelectTriggerProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Trigger
> & {
  ref?: Ref<ComponentRef<typeof SelectPrimitive.Trigger>>;
};

export function GmailSelectTrigger({
  className,
  children,
  ref,
  ...props
}: GmailSelectTriggerProps) {
  return (
...
type GmailSelectContentProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Content
> & {
  ref?: Ref<ComponentRef<typeof SelectPrimitive.Content>>;
};

export function GmailSelectContent({
  className,
  children,
  position = "popper",
  ref,
  ...props
}: GmailSelectContentProps) {
  return (
...
type GmailSelectItemProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Item
> & {
  ref?: Ref<ComponentRef<typeof SelectPrimitive.Item>>;
};

export function GmailSelectItem({
  className,
  children,
  ref,
  ...props
}: GmailSelectItemProps) {
  return (
