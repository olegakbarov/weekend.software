...
// ---------------------------------------------------------------------------
//
// Lets consumers nest the tooltip's portal inside a CSS-scaled ancestor so the
// tooltip visually scales with its surroundings (used by upstream `/demo`
// carousels). Tooltip reads the nearest provider; if none is mounted the
// portal falls back to `document.body` (Radix default).
