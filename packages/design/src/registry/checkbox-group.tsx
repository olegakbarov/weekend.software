...
/**
 * Vertical checkbox list with proximity-hover, animated focus ring, and a
 * **merged** background that visually groups contiguous checked items into a
 * single block. Ports `registry/default/checkbox-group.tsx` from upstream.
 *
 * The radix `<Checkbox>` primitive is omitted — accessibility comes from
 * native `role="checkbox"` + `aria-checked` on the item div, plus full
 * keyboard support (Space/Enter to toggle, Arrow/Home/End to navigate).
 */
